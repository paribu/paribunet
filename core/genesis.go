...
func SetupGenesisBlockWithOverride(db ethdb.Database, genesis *Genesis, overrideBerlin *big.Int) (*params.ChainConfig, common.Hash, error) {
	...
	syscontracts.GenesisHash = stored
	...
	if genesis == nil && stored != params.MainnetGenesisHash && stored != params.ParibuNetMainnetGenesisHash && stored != params.ParibuNetTestnetGenesisHash {
...
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ChainConfig {
	...
	case ghash == params.ParibuNetMainnetGenesisHash:
		return params.ParibuNetMainnetConfig
	case ghash == params.ParibuNetTestnetGenesisHash:
		return params.ParibuNetTestnetConfig
	default:
